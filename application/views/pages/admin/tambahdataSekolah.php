        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-6 col-md-6 ">
                    <form action="<?= base_url('admin/tambahDataSekolah') ?>" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                            <label for="example-text-input" class="col-form-label">Nama Sekolah</label>
                            <input class="form-control col-8" type="text" value="" id="" name="nama_sekolah" required>
                        </div>
                        <div class="form-group">
                            <label for="example-text-input" class="col-form-label">NPSN</label>
                            <input class="form-control col-8" type="text" value="" id="" name="npsn" required>
                        </div>
                        <div class="form-group">
